  ...
  return (
    <>
      ...
      <div className="ev-shell">
        <Sidebar activePath="/super-admin/white-label" />
        <div className="ev-main">
          
          <header className="sa-tb">
            <div className="sa-tb-left">
              <h1 className="sa-tb-hello">White-Label Branding Settings</h1>
              <p className="sa-tb-sub">Customize domains, themes, splashscreens and customer communications branding.</p>
            </div>
